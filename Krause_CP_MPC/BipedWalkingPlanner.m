...
foot_pnt1 = zeros(2, sim_tick);
foot_pnt2 = zeros(2, sim_tick);
foot_pnt3 = zeros(2, sim_tick);
foot_pnt4 = zeros(2, sim_tick);
...
for i = 1:1:sim_tick + 1000
    ...
    % foot
    foot_tmp = [ZmpRef_x(i,1); ZmpRef_y(i,1)]
    foot_pnt1(:, i) = foot_tmp + R * [ 0.17; 0.10]; 
    foot_pnt2(:, i) = foot_tmp + R * [-0.13; 0.10]; 
    foot_pnt3(:, i) = foot_tmp + R * [-0.13;-0.10]; 
    foot_pnt4(:, i) = foot_tmp + R * [ 0.17;-0.10]; 
...
for i = 1:1:sim_tick
    ...
    % i = 605
    x = [foot_pnt1(1,i), foot_pnt2(1,i), foot_pnt3(1,i), foot_pnt4(1,i)];
    y = [foot_pnt1(2,i), foot_pnt2(2,i), foot_pnt3(2,i), foot_pnt4(2,i)];
    pgon = polyshape(x, y)
    % plot(pgon, 'FaceColor', 'red', 'FaceAlpha', 0.3, 'EdgeColor', 'black', 'HandleVisibility', 'off');

    union_poly = union([union_poly, pgon]);
end

plot(union_poly, 'FaceColor', 'none', 'FaceAlpha', 0.5, 'EdgeColor', 'black', 'HandleVisibility', 'off');
